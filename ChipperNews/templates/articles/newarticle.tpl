...
<div id="bg">
  ...
  <div class="ink-grid content-drawer">
    <form action="{$BASE_URL}actions/articles/newarticle.php" class="ink-form ink-formvalidator xlarge-60 large-70 medium-90 all-100 push-center quarter-vertical-padding"
