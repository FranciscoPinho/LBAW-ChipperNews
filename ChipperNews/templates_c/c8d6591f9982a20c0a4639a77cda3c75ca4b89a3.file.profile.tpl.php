<?php /* Smarty version Smarty-3.1.15, created on 2017-05-28 01:58:09
...
?>
                                        ...
                                        <div class="tab-pane fade" id="settings">
                                            <ul class="list-group">     
                                                <li class="list-group-item"><b>Hide email from anyone who visits my profile </b><input type="checkbox" onclick="checkEmail()" id="email_hide" name="email_hide" data-toggle="toggle" data-size="small" data-onstyle="success"></li>
